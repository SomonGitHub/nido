...
function jn(n, t, r, i, o, a, s, l, p, d, h) {
  var c, m, f, v, b, u, _, g = i && i.__k || we, w = t.length;
  for (p = yt(r, t, g, p, w), c = 0; c < w; c++) (f = r.__k[c]) != null && (m = f.__i != -1 && g[f.__i] || ye, f.__i = c, u = Fe(n, f, m, o, a, s, l, p, d, h), v = f.__e, f.ref && m.ref != f.ref && (m.ref && He(m.ref, null, f), h.push(f.ref, f.__c || v, f)), b == null && v != null && (b = v), (_ = !!(4 & f.__u)) || m.__k === f.__k ? (p = Vn(f, p, n, _), _ && m.__e && (m.__e = null)) : typeof f.type == "function" && u !== void 0 ? p = u : v && (p = v.nextSibling), f.__u &= -7);
  return r.__e = b, p;
}
...
function Fe(n, t, r, i, o, a, s, l, p, d) {
  var h, c, m, f, v, b, u, _, g, w, S, T, $, C, R, N = t.type;
  if (t.constructor !== void 0) return null;
  128 & r.__u && (p = !!(32 & r.__u), a = [l = t.__e = r.__e]), (h = E.__b) && h(t);
  e: if (typeof N == "function") try {
    if (_ = t.props, g = N.prototype && N.prototype.render, w = (h = N.contextType) && i[h.__c], S = h ? w ? w.props.value : h.__ : i, r.__c ? u = (c = t.__c = r.__c).__ = c.__E : (g ? t.__c = c = new N(_, S) : (t.__c = c = new ve(_, S), c.constructor = N, c.render = Mt), w && w.sub(c), c.state || (c.state = {}), c.__n = i, m = c.__d = !0, c.__h = [], c._sb = []), g && c.__s == null && (c.__s = c.state), g && N.getDerivedStateFromProps != null && (c.__s == c.state && (c.__s = Z({}, c.__s)), Z(c.__s, N.getDerivedStateFromProps(_, c.__s))), f = c.props, v = c.state, c.__v = t, m) g && N.getDerivedStateFromProps == null && c.componentWillMount != null && c.componentWillMount(), g && c.componentDidMount != null && c.__h.push(c.componentDidMount);
    else {
    ...
    const m = (v) => {
      ...
      if (b.pointerType === "touch") {
        if (!b.entered) {
          ...
          if (Math.hypot(_, g) > Wt) {
            if (b.timerId && clearTimeout(b.timerId), b.pointerId != null) {
              const w = s.current?.querySelector(`[data-drag-id="${b.id}"]`);
              if (w) try {
      ...
      window.addEventListener("click", b, { capture: !0, once: !0 }), o((u) => {
        ...
        if (_ && g && _ !== g) {
          const w = l.current, S = d.current, T = w.findIndex((C) => S(C) === _), $ = w.findIndex((C) => S(C) === g);
          if (T >= 0 && $ >= 0) {
            const C = [...w], [R] = C.splice(T, 1);
          ...
          if (!Bt(b.target, u))
            if (b.pointerType === "touch") {
              ...
              const g = window.setTimeout(() => {
                const w = a.current;
                w && w.id === m && !w.entered && (w.entered = !0, o({ draggingId: m, overId: null }), "vibrate" in navigator && navigator.vibrate(50));
              }, 2e3);
              a.current = { id: m, x: b.clientX, y: b.clientY, entered: !1, pointerType: "touch", timerId: g, pointerId: b.pointerId };
            } else
...
function st({
  ...
  const o = t.state.state === "unavailable", a = t.state.state, s = a !== "off" && !o, l = t.state.attributes.current_temperature, p = t.state.attributes.temperature, d = t.state.attributes.min_temp ?? 7, h = t.state.attributes.max_temp ?? 35, c = t.state.attributes.target_temp_step ?? 0.5, [m, f] = M(null), v = m ?? p ?? l ?? 20, b = async (g) => {
    const w = Math.min(h, Math.max(d, g));
    f(w);
    try {
...
function pt({
  ...
  const o = t.state.state, a = o === "unavailable", s = o === "playing", l = o === "off" || o === "standby", p = t.state.attributes.media_title, d = t.state.attributes.media_artist, h = t.state.attributes.app_name, c = t.state.attributes.volume_level, [m, f] = M(null), v = m ?? c ?? 0, b = async (g, w = {}) => {
      ...
      /* @__PURE__ */ e("div", { class: "nido-weather-panel__scroll", children: [
        ...
        a.length > 0 && /* @__PURE__ */ e("div", { class: "nido-wp-section", children: [
          ...
          /* @__PURE__ */ e("div", { class: "nido-wp-hourly", children: a.slice(0, 24).map((_, g) => {
            const w = se(_.condition), S = new Date(_.datetime);
        ...
        i.length > 0 && /* @__PURE__ */ e("div", { class: "nido-wp-section", children: [
          ...
          /* @__PURE__ */ e("div", { class: "nido-wp-daily", children: i.slice(0, 5).map((_, g) => {
            const w = se(_.condition), S = new Date(_.datetime), T = new Intl.DateTimeFormat("fr-FR", { weekday: "long" }).format(S);
...
function ta({
  ...
  const h = n.user?.name ?? "vous", c = /* @__PURE__ */ new Date(), m = c.getHours(), { greeting: f, sub: v } = Gr(m), b = `${String(m).padStart(2, "0")}:${String(c.getMinutes()).padStart(2, "0")}`, u = c.toLocaleDateString("fr-FR", { weekday: "long", day: "numeric", month: "long" }).replace(/^\w/, (k) => k.toUpperCase()), _ = D(() => new Set(o), [o]), g = D(
    () => r.filter((k) => _.has(k.entity_id) && Xr.has(k.domain)),
    [r, _]
  ), w = D(
    () => g.find((k) => k.domain === "weather"),
    [g]
  ), S = D(() => w ? Object.keys(n.states).some(
    (y) => y.startsWith("sensor.") && (y.endsWith("_next_rain") || y.endsWith("_weather_alert") || y.endsWith("_uv"))
  ) : !1, [n.states, w]), [T, $] = M(!1), C = D(() => Object.values(n.states).filter(
    (k) => k.entity_id.startsWith("person.") && k.state === "home" && k.attributes.entity_picture
  ), [n.states]), R = (k) => {
    if (!k) return null;
    if (k.startsWith("http")) return k;
    const y = n.hassUrl?.("");
    return y ? y.replace(/\/$/, "") + k : k;
  }, N = D(() => Nt(g), [g]), j = D(() => ea(n, t), [n.states, t]), X = D(() => {
    const k = new Map(g.map((y) => [y.entity_id, y]));
    return i.map((y) => k.get(y)).filter((y) => !!y);
  }, [g, i]), Y = D(() => {
    const k = t.filter((y) => (N.get(y.area_id) ?? []).length > 0);
    return Xn(k, a, (y) => y.area_id);
  }, [t, N, a]), U = Le(
    X,
    (k) => k.entity_id,
    (k) => p(k.map((y) => y.entity_id))
  ), G = Le(
    Y,
    (k) => k.area_id,
    (k) => d(k.map((y) => y.area_id))
  );
  let Q = 0;
        ...
        children: X.map((k) => {
          ...
          return /* @__PURE__ */ e(
            "div",
            {
              ...
              ...U.itemPropsFor(k.entity_id),
              children: Kr(k, {
                hass: n,
                areaName: t.find((W) => W.area_id === k.area_id)?.name ?? "",
                hero: Q === 1 && k.domain === "light",
                variant: y
              })
            },
            k.entity_id
        ...
        /* @__PURE__ */ e("div", { class: "nido-topbar__actions", children: [
          w && (S ? /* @__PURE__ */ e(
            "button",
            {
              ...
              children: /* @__PURE__ */ e(zn, { entity: w })
            }
          ) : /* @__PURE__ */ e(zn, { entity: w })),
          /* @__PURE__ */ e(
            "button",
            {
              type: "button",
      ...
      /* @__PURE__ */ e("section", { class: "nido-hero", children: [
        ...
        /* @__PURE__ */ e("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "16px" }, children: [
          ...
          C.length > 0 && /* @__PURE__ */ e("div", { class: "nido-home-pill", children: [
            /* @__PURE__ */ e("div", { class: "nido-home-pill__avatars", children: C.map((k) => {
              const y = R(k.attributes.entity_picture);
              return y ? /* @__PURE__ */ e(
                "img",
                {
                  src: y,
        ...
        Y.length > 0 && /* @__PURE__ */ e("section", { class: "nido-rooms-section", children: [
          ...
          /* @__PURE__ */ e(
            "div",
            {
              ...
              ref: (k) => {
                G.containerRef.current = k;
              },
              children: Y.map((k, y) => /* @__PURE__ */ e(
                na,
                {
                  area: k,
                  entities: N.get(k.area_id) ?? [],
                  accent: y === 0,
                  onOpen: () => l(k.area_id),
                  dragProps: G.itemPropsFor(k.area_id),
                  presence: j.get(k.area_id)
                },
                k.area_id
              ))
            }
...
function aa({
  ...
  const s = bt(t.name), l = Yn(r), p = D(
    ...
    (u) => u.entity_id,
    (u) => {
      const _ = new Set(m.map((S) => S.entity_id)), g = [...u], w = p.map(
        (S) => _.has(S.entity_id) ? g.shift() : S
      );
      a(w.map((S) => S.entity_id));
    }
  ), v = p.filter(
...
function ia(n) {
  const {
    ...
    onClose: c,
    onDone: m
  } = n, [f, v] = M(0), [b, u] = M(o), [_, g] = M(a), [w, S] = M(new Set(s)), [T, $] = M(new Set(l)), [C, R] = M(
    new Set(p)
  ...
  const U = () => v((I) => Math.min(_e - 1, I + 1)), G = () => v((I) => Math.max(0, I - 1)), Q = (I, z) => {
    ...
    const I = Array.from(w), z = Array.from(T).filter((V) => w.has(V)), A = Array.from(C);
    ...
    xn(b, _), mn(Array.from(w)), De(Array.from(T).filter((I) => w.has(I))), gn(Array.from(C)), vn(), c();
  };
  ...
  return /* @__PURE__ */ e("div", { class: "n-ob-step n-ob-step--entities", children: [
    /* @__PURE__ */ e("aside", { class: "n-ob-ent__rail", children: [
      ...
      /* @__PURE__ */ e("div", { class: "n-ob-ent__list", children: s.map(([u, _]) => {
        const g = ae[u], w = g.Icon, S = _.filter(($) => r.has($.entity_id)).length;
        return /* @__PURE__ */ e(
          "button",
          {
            type: "button",
    ...
    /* @__PURE__ */ e("section", { class: "n-ob-ent__main", children: c && /* @__PURE__ */ e(F, { children: [
      ...
      /* @__PURE__ */ e("div", { class: "n-ob-ent__grid", children: [
        ...
        b.map((u) => {
          const _ = r.has(u.entity_id), g = i.has(u.entity_id), w = ae[u.domain].Icon;
          return /* @__PURE__ */ e(
            "div",
            {
...
function ua({ hass: n, host: t }) {
  const [r, i] = M(null), [o, a] = M(null), [s, l] = M(null), [p, d] = M(null), h = D(() => Jn(), []), [c, m] = M(() => Dt()), [f, v] = M(() => Lt()), [b, u] = M(() => jt()), [_, g] = M(() => Vt()), [w, S] = M(
    () => Ft()
  ), [T, $] = M(() => !bn()), [C, R] = M(
    { kind: "dashboard" }
  ), N = (y) => {
  ...
  const ee = D(() => new Set(f), [f]), H = C.kind === "room" ? r.find((y) => y.area_id === C.areaId) ?? null : null, k = D(
    () => H ? U.filter(
