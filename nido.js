var Fe, W, lt, oe, zn, ct, dt, Ye, Ae, fe, pt, cn, nn, tn, $e = {}, Pe = [], di = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, Re = Array.isArray;
function ie(n, t) {
...
function Ee(n, t, i, r, o) {
  var a = { type: n, props: t, key: i, ref: r, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: o ?? ++lt, __i: -1, __u: 0 };
...
function pi(n) {
  if (n.__P && n.__d) {
    ...
    a.__v = t.__v + 1, W.vnode && W.vnode(a), pn(n.__P, a, t, n.__n, n.__P.namespaceURI, 32 & t.__u ? [i] : null, r, i ?? de(t), !!(32 & t.__u), o), a.__v = t.__v, a.__.__k[a.__i] = a, gt(r, a, o), t.__e = t.__ = null, a.__e != i && ht(a);
  }
}
function ht(n) {
...
function Sn(n) {
  (!n.__d && (n.__d = !0) && oe.push(n) && !Ne.__r++ || zn != W.debounceRendering) && ((zn = W.debounceRendering) || ct)(Ne);
}
function Ne() {
  try {
    for (var n, t = 1; oe.length; ) oe.length > t && oe.sort(dt), n = oe.shift(), t = oe.length, pi(n);
  } finally {
    oe.length = Ne.__r = 0;
  }
}
function _t(n, t, i, r, o, a, s, l, p, c, u) {
  var d, h, g, v, b, m, f, _ = r && r.__k || Pe, x = t.length;
  for (p = ui(i, t, _, p, x), d = 0; d < x; d++) (g = i.__k[d]) != null && (h = g.__i != -1 && _[g.__i] || $e, g.__i = d, m = pn(n, g, h, o, a, s, l, p, c, u), v = g.__e, g.ref && h.ref != g.ref && (h.ref && un(h.ref, null, g), u.push(g.ref, g.__c || v, g)), b == null && v != null && (b = v), (f = !!(4 & g.__u)) || h.__k === g.__k ? (p = ft(g, p, n, f), f && h.__e && (h.__e = null)) : typeof g.type == "function" && m !== void 0 ? p = m : v && (p = v.nextSibling), g.__u &= -7);
  return i.__e = b, p;
}
function ui(n, t, i, r, o) {
  ...
  if (d) for (a = 0; a < u; a++) (l = i[a]) != null && (2 & l.__u) == 0 && (l.__e == r && (r = de(l)), bt(l, l));
  return r;
}
function ft(n, t, i, r) {
  var o, a;
  if (typeof n.type == "function") {
    for (o = n.__k, a = 0; o && a < o.length; a++) o[a] && (o[a].__ = n, t = ft(o[a], t, i, r));
    return t;
  }
...
function we(n, t, i, r, o) {
  ...
  else if (t[0] == "o" && t[1] == "n") a = t != (t = t.replace(pt, "$1")), s = t.toLowerCase(), t = s in n || t == "onFocusOut" || t == "onFocusIn" ? s.slice(2) : t.slice(2), n.l || (n.l = {}), n.l[t + a] = i, i ? r ? i[fe] = r[fe] : (i[fe] = cn, n.addEventListener(t, a ? tn : nn, a)) : n.removeEventListener(t, a ? tn : nn, a);
  else {
...
function pn(n, t, i, r, o, a, s, l, p, c) {
  var u, d, h, g, v, b, m, f, _, x, z, M, T, S, j, $ = t.type;
  if (t.constructor !== void 0) return null;
  128 & i.__u && (p = !!(32 & i.__u), a = [l = t.__e = i.__e]), (u = W.__b) && u(t);
  e: if (typeof $ == "function") try {
    if (f = t.props, _ = $.prototype && $.prototype.render, x = (u = $.contextType) && r[u.__c], z = u ? x ? x.props.value : u.__ : r, i.__c ? m = (d = t.__c = i.__c).__ = d.__E : (_ ? t.__c = d = new $(f, z) : (t.__c = d = new De(f, z), d.constructor = $, d.render = fi), x && x.sub(d), d.state || (d.state = {}), d.__n = r, h = d.__d = !0, d.__h = [], d._sb = []), _ && d.__s == null && (d.__s = d.state), _ && $.getDerivedStateFromProps != null && (d.__s == d.state && (d.__s = ie({}, d.__s)), ie(d.__s, $.getDerivedStateFromProps(f, d.__s))), g = d.props, v = d.state, d.__v = t, h) _ && $.getDerivedStateFromProps == null && d.componentWillMount != null && d.componentWillMount(), _ && d.componentDidMount != null && d.__h.push(d.componentDidMount);
    else {
      if (_ && $.getDerivedStateFromProps == null && f !== g && d.componentWillReceiveProps != null && d.componentWillReceiveProps(f, z), t.__v == i.__v || !d.__e && d.shouldComponentUpdate != null && d.shouldComponentUpdate(f, d.__s, z) === !1) {
    ...
    if (d.context = z, d.props = f, d.__P = n, d.__e = !1, M = W.__r, T = 0, _) d.state = d.__s, d.__d = !1, M && M(t), u = d.render(d.props, d.state, d.context), Pe.push.apply(d.__h, d._sb), d._sb = [];
    else do
      d.__d = !1, M && M(t), u = d.render(d.props, d.state, d.context), d.state = d.__s;
    while (d.__d && ++T < 25);
    d.state = d.__s, d.getChildContext != null && (r = ie(ie({}, r), d.getChildContext())), _ && !h && d.getSnapshotBeforeUpdate != null && (b = d.getSnapshotBeforeUpdate(g, v)), S = u != null && u.type === J && u.key == null ? mt(u.props.children) : u, l = _t(n, Re(S) ? S : [S], t, i, r, o, a, s, l, p, c), d.base = t.__e, t.__u &= -161, d.__h.length && s.push(d), m && (d.__E = d.__ = null);
  } catch (L) {
...
function mt(n) {
  return typeof n != "object" || n == null || n.__b > 0 ? n : Re(n) ? n.map(mt) : ie({}, n);
}
function _i(n, t, i, r, o, a, s, l, p) {
  var c, u, d, h, g, v, b, m = i.props || $e, f = t.props, _ = t.type;
  ...
  if (_ == null) m === f || l && n.data == f || (n.data = f);
    ...
    else if (d && (n.innerHTML = ""), _t(t.type == "template" ? n.content : n, Re(h) ? h : [h], t, i, r, _ == "foreignObject" ? "http://www.w3.org/1999/xhtml" : o, a, s, a ? a[0] : i.__k && de(i, 0), l, p), a != null) for (c = a.length; c--; ) dn(a[c]);
...
function bt(n, t, i) {
  ...
  if (r = n.__k) for (o = 0; o < r.length; o++) r[o] && bt(r[o], t, i || typeof n.type != "function");
...
function An(n, t, i) {
  var r, o, a, s;
  t == document && (t = document.documentElement), W.__ && W.__(n, t), o = (r = !1) ? null : t.__k, a = [], s = [], pn(t, n = t.__k = ut(J, null, [n]), o || $e, $e, t.namespaceURI, o ? null : t.firstChild ? Fe.call(t.childNodes) : null, a, o ? o.__e : t.firstChild, r, s), gt(a, n, s);
}
Fe = Pe.slice, W = { __e: function(n, t, i, r) {
  ...
  throw n;
} }, lt = 0, De.prototype.setState = function(n, t) {
  var i;
...
}, De.prototype.render = J, oe = [], ct = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, dt = function(n, t) {
  return n.__v.__b - t.__v.__b;
}, Ne.__r = 0, Ye = Math.random().toString(8), Ae = "__d" + Ye, fe = "__a" + Ye, pt = /(PointerCapture)$|Capture$/i, cn = 0, nn = Cn(!1), tn = Cn(!0);
var gi = 0;
...
var be, U, Ze, En, ve = 0, vt = [], q = W, Dn = q.__b, Tn = q.__r, $n = q.diffed, Pn = q.__c, Nn = q.unmount, Ln = q.__;
function hn(n, t) {
...
function mi(n, t, i) {
  var r = hn(be++, 2);
  if (r.t = n, !r.__c && (r.__ = [yt(void 0, t), function(l) {
...
function Q(n, t) {
  var i = hn(be++, 3);
  !q.__s && xt(i.__H, t) && (i.__ = n, i.u = t, U.__H.__h.push(i));
}
function Z(n) {
...
function N(n, t) {
  var i = hn(be++, 7);
  return xt(i.__H, t) && (i.__ = n(), i.__H = t, i.__h = n), i.__;
}
function X(n, t) {
...
q.__b = function(n) {
  ...
  $n && $n(n);
  var t = n.__c;
  t && t.__H && (t.__H.__h.length && (vt.push(t) !== 1 && En === q.requestAnimationFrame || ((En = q.requestAnimationFrame) || vi)(bi)), t.__H.__.some(function(i) {
...
}, kt = ["terracotta", "miel", "sauge", "cosy"], Si = ["light", "dark"];
function ne() {
  try {
...
const Ci = () => fn(K.exposed), On = (n) => gn(K.exposed, n), Ai = () => fn(K.excludedUsers), Fn = (n) => gn(K.excludedUsers, n), Ei = () => fn(K.roomsOrder), Di = (n) => gn(K.roomsOrder, n);
function Ti() {
  const n = ne();
  if (!n) return {};
...
function Mt() {
  ...
  return {
    theme: kt.includes(t) ? t : "terracotta",
...
function sn(n, t, i) {
  ...
  Q(() => {
    const h = (b) => {
      ...
      Math.hypot(_, x) <= ji ? b.preventDefault() : (m.timerId && clearTimeout(m.timerId), a.current = null);
    }, g = (b) => {
      const m = a.current;
      if (!m) return;
      ...
      window.addEventListener("click", m, { capture: !0, once: !0 }), o((f) => {
        ...
        if (_ && x && _ !== x) {
          const z = l.current, M = c.current, T = z.findIndex((j) => M(j) === _), S = z.findIndex((j) => M(j) === x);
          if (T >= 0 && S >= 0) {
            const j = [...z], [$] = j.splice(T, 1);
            j.splice(S, 0, $), p.current(j);
          }
        }
...
] }), It = (n) => /* @__PURE__ */ e(y, { ...n, children: /* @__PURE__ */ e("path", { d: "m9 6 6 6-6 6" }) }), mn = (n) => /* @__PURE__ */ e(y, { ...n, children: [
...
] }), Hi = (n) => /* @__PURE__ */ e(y, { ...n, children: /* @__PURE__ */ e("path", { d: "M12 3s-6 7-6 11a6 6 0 0 0 12 0c0-4-6-11-6-11Z" }) }), Wi = (n) => /* @__PURE__ */ e(y, { ...n, children: [
...
] }), Pt = (n) => /* @__PURE__ */ e(y, { ...n, children: /* @__PURE__ */ e("path", { d: "m15 6-6 6 6 6" }) }), Nt = (n) => /* @__PURE__ */ e(y, { ...n, children: [
...
function Ht({ entity: n, roomLabel: t, hero: i = !1 }) {
...
function Wt({
  ...
  }, f = Ea[s] ?? se, x = ["n-card", o ? l ? "n-card--accent" : "n-card--accent-muted" : "", l ? `breathe-${r}` : ""].filter(Boolean).join(" ");
...
function qt({
  ...
  const a = t.state.state, s = a === "unavailable", l = a === "playing", p = a === "off" || a === "standby", c = t.state.attributes.media_title, u = t.state.attributes.media_artist, d = t.state.attributes.app_name, h = t.state.attributes.volume_level, g = t.state.attributes.entity_picture, [v, b] = I(null), m = v ?? h ?? 0, f = async (M, T = {}) => {
    ...
    "div",
    {
      ...
      children: [
        ...
        !o && /* @__PURE__ */ e("div", { class: "n-alarm__modes", children: [
          La.map(({ id: d, service: h, label: g, Icon: v }) => /* @__PURE__ */ e(
            "button",
            {
              type: "button",
              class: "n-mode-btn",
      ...
      try {
        const x = async (T) => {
          try {
            ...
            return console.warn(`Failed to fetch ${T} forecast:`, S), [];
          }
  ...
  return /* @__PURE__ */ e("div", { class: "nido-notification-panel", children: [
    ...
    /* @__PURE__ */ e("div", { class: "nido-notification-panel__content", children: [
      ...
      /* @__PURE__ */ e("div", { class: "nido-notification-panel__scroll", children: t.length === 0 ? /* @__PURE__ */ e("div", { class: "nido-notification-empty", children: [
        /* @__PURE__ */ e("div", { class: "nido-notification-empty__icon", children: /* @__PURE__ */ e(St, { size: 48 }) }),
...
const Ge = "nido.shoppingColor", Jn = "nido.shoppingSize", Ja = 600;
function Kn(n, t, i) {
...
function Ka({ hass: n, onClose: t, topicBase: i = "shopping" }) {
  const r = Z(null), o = Z(null), a = Z([]), s = Z(null), l = Z(null), p = Z({ w: 0, h: 0 }), c = Z(null), u = Z("nido-" + Math.random().toString(36).slice(2, 8)), [d, h] = I(() => localStorage.getItem(Ge) || "#1a1410"), [g, v] = I(() => parseInt(localStorage.getItem(Jn) || "4", 10));
  Q(() => {
  ...
  const f = X((w) => [w[0] * p.current.w, w[1] * p.current.h], []), _ = X(() => {
    const w = r.current;
    if (!w) return;
    ...
    for (const O of a.current)
      C.strokeStyle = O.color, Kn(C, O.points.map(f), O.size * D);
    s.current && (C.strokeStyle = s.current.color, Kn(C, s.current.points.map(f), s.current.size * D));
  }, [f]), x = X(() => {
...
function ii({
  ...
  }, [s, l]), u = Math.max(0, Math.min(1, c / i)), d = 100, h = 100, g = 86, [v, b] = Xe(0, d, h, g), [m, f] = Xe(1, d, h, g), [_, x] = Xe(u, d, h, g), z = `M ${v.toFixed(2)} ${b.toFixed(2)} A ${g} ${g} 0 0 1 ${m.toFixed(2)} ${f.toFixed(2)}`, M = u > 0.5 ? 1 : 0, T = u > 0 ? `M ${v.toFixed(2)} ${b.toFixed(2)} A ${g} ${g} 0 ${M} 1 ${_.toFixed(2)} ${x.toFixed(2)}` : "", S = c >= 5e3 ? "Pic" : c >= 2e3 ? "Soutenu" : "Sobre", j = ["n-card", "n-card--accent", "breathe-1", "n-power-gauge"].join(" "), $ = typeof r == "function";
  return /* @__PURE__ */ e(
    "div",
    {
      class: j,
      ...
      children: [
        ...
        /* @__PURE__ */ e("div", { class: "n-power-gauge__head", children: [
          ...
          /* @__PURE__ */ e("div", { class: "n-power-gauge__head-actions", children: [
            ...
            $ && /* @__PURE__ */ e("span", { class: "n-power-gauge__open", "aria-hidden": "true", children: /* @__PURE__ */ e(Tt, { size: 14 }) })
          ] })
        ] }),
...
const Oe = 64, ke = 80, Me = 80, Xn = 270 / 360 * 2 * Math.PI * Oe, Qn = 2 * Math.PI * Oe;
function ir({
  currentPower: n,
  subscribedKva: t = 9
}) {
...
function ur({
  ...
  Q(() => {
    ...
    return (async () => {
      ...
      try {
        if (l === "day") {
          const $ = ar(new Date(Date.now() - 828e5)), L = /* @__PURE__ */ new Date(), G = await n.callWS({
          ...
          const $ = l === "week" ? 7 : 30, L = rr(new Date(Date.now() - ($ - 1) * 864e5)), G = /* @__PURE__ */ new Date();
          let V = [], Y = 0, ee = !1;
          try {
          ...
          if (!ee) {
            ...
            if (S) return;
            const D = C?.[t] ?? [], O = et(D, L.getTime(), G.getTime(), $, 864e5);
            V = O.buckets, Y = O.total;
          }
          const w = nt(l, L.getTime());
          o({
            buckets: V,
            total: Y,
            available: Y > 0,
            ...
            bucketLabel: w.bucketLabel,
            unit: "kWh",
            nowIndex: pr(l, L.getTime())
          });
        }
      } catch ($) {
        if (S) return;
        console.warn("Nido energy: history fetch failed", $), o({
  ...
  return /* @__PURE__ */ e("div", { class: "n-card n-hourly", children: [
    ...
    a ? /* @__PURE__ */ e("div", { class: "n-muted n-hourly__loading", children: "Chargement de l'historique…" }) : b ? /* @__PURE__ */ e(J, { children: [
      /* @__PURE__ */ e("div", { class: "n-bars", children: [
        _ > 0 && /* @__PURE__ */ e("div", { class: "n-bars__avg", style: { bottom: `${_ / x * 100}%` }, children: /* @__PURE__ */ e("span", { class: "n-bars__avg-label", children: T }) }),
        /* @__PURE__ */ e("div", { class: "n-bars__grid", children: h.map((S, j) => {
          const $ = j === m, L = j < m, G = S > 0 && S === z;
          let V = "n-bars__bar";
          return $ ? V += " is-now" : G ? V += " is-peak" : L ? V += " is-past" : V += " is-future", /* @__PURE__ */ e("div", { class: "n-bars__col", children: [
            /* @__PURE__ */ e("div", { class: V, style: { height: `${Math.max(2, S / x * 100)}%` } }),
            $ && /* @__PURE__ */ e("div", { class: "n-bars__now-label", children: [
              S.toFixed(2),
              " kWh"
            ] })
          ] }, j);
      ...
      return /* @__PURE__ */ e(
        "div",
        {
          ...
          children: [
            ...
            u && /* @__PURE__ */ e("span", { class: "n-top-consumers__chevron", "aria-hidden": "true", children: /* @__PURE__ */ e(It, { size: 14 }) })
          ]
        },
        l.entity.entity_id
      );
...
const te = "sensor.consommation_electrique_sinsts", tt = "sensor.conso_daily", _r = "sensor.conso", fr = "select.conso_hebdomadaire_2_en_eur", gr = 9;
function mr({ hass: n, entities: t, exposed: i, areas: r, onBack: o }) {
  ...
  }, [l, p]), u = l?.attributes.unit_of_measurement ?? "W", d = n.states[tt], h = N(() => {
    if (!d) return null;
    const M = Number(d.state);
    return Number.isFinite(M) ? M : null;
  }, [d]), g = d?.attributes.unit_of_measurement ?? "kWh", v = n.states[_r], b = N(() => {
    if (!v) return null;
    const M = Number(v.state);
    return Number.isFinite(M) ? M : null;
  }, [v]), m = v?.attributes.unit_of_measurement ?? "€", f = n.states[fr], _ = N(() => {
    if (!f) return null;
    const M = f.state;
    if (M === "unavailable" || M === "unknown") return null;
    const T = Number(M);
    return Number.isFinite(T) ? T : null;
  }, [f]), x = f?.state ?? null, z = N(() => (/* @__PURE__ */ new Date()).toLocaleDateString("fr-FR", { weekday: "long", day: "numeric", month: "long" }).replace(/^\w/, (T) => T.toUpperCase()), []);
...
function xr(n, t) {
  ...
  switch (n.domain) {
    ...
    case "binary_sensor":
      return /* @__PURE__ */ e(Ht, { entity: n, roomLabel: t.areaName, hero: t.hero }, n.entity_id);
    case "climate":
...
function kr({ area: n, entities: t, accent: i = !1, onOpen: r, dragProps: o, presence: a }) {
  ...
  ).length, p = t.filter(_n).length, c = wt(t);
  return /* @__PURE__ */ e(
    "div",
    {
      role: "button",
...
function Mr({
  ...
  const d = n.user?.name ?? "vous", h = /* @__PURE__ */ new Date(), g = h.getHours(), { greeting: v, sub: b } = vr(g), m = `${String(g).padStart(2, "0")}:${String(h.getMinutes()).padStart(2, "0")}`, f = h.toLocaleDateString("fr-FR", { weekday: "long", day: "numeric", month: "long" }).replace(/^\w/, (k) => k.toUpperCase()), _ = N(() => new Set(o), [o]), x = N(
    () => i.filter((k) => _.has(k.entity_id) && br.has(k.domain)),
    [i, _]
  ), z = N(
  ...
  ) : !1, [n.states, z]), [$, L] = I(!1), [G, V] = I(!1), [Y, ee] = I(!1), [w, C] = I(!1), D = N(() => {
  ...
  Q(() => {
    ...
    D.some((re) => !k.has(re.id)) && Ba(), O.current = new Set(D.map((re) => re.id));
  }, [D]);
  const A = N(() => Pi(), [G]), E = N(() => {
        ...
        /* @__PURE__ */ e("div", { class: "nido-topbar__actions", children: [
          z && (j ? /* @__PURE__ */ e(
            "button",
            {
              ...
              children: /* @__PURE__ */ e(Zn, { entity: z })
            }
          ) : /* @__PURE__ */ e(Zn, { entity: z })),
          T > 0 && /* @__PURE__ */ e(
            "button",
            {
              type: "button",
              ...
              onClick: () => ee(!0),
              "aria-label": `${T} lumière${T > 1 ? "s" : ""} allumée${T > 1 ? "s" : ""}`,
              children: /* @__PURE__ */ e("div", { class: "nido-lights-pill", children: [
                /* @__PURE__ */ e(ye, { size: 16 }),
                /* @__PURE__ */ e("span", { class: "nido-lights-pill__count", children: T }),
                /* @__PURE__ */ e("span", { class: "nido-lights-pill__label", children: T === 1 ? "lumière" : "lumières" })
              ] })
            }
          ),
          /* @__PURE__ */ e(
...
function zr(n, t, i, r, o, a = !1) {
  ...
  switch (n.domain) {
    ...
    case "binary_sensor":
      return /* @__PURE__ */ e(Ht, { entity: n, roomLabel: i, hero: a }, n.entity_id);
    case "climate":
...
function Sr({
  ...
  const s = Qt(t.name), l = wt(i), p = N(
    () => zt(i, r, (_) => _.entity_id),
    [i, r]
  ), c = N(
    () => p.filter((_) => {
    ...
    (_) => _.entity_id,
    (_) => {
      const x = new Set(v.map((T) => T.entity_id)), z = [..._], M = p.map(
        (T) => x.has(T.entity_id) ? z.shift() : T
      );
...
function Ir(n) {
  const {
    ...
    onClose: d,
    onDone: h
  } = n, [g, v] = I(0), [b, m] = I(o), [f, _] = I(a), [x, z] = I(new Set(s)), [M, T] = I(new Set(l)), [S, j] = I(
    new Set(p)
  ), [$, L] = I(null), [G, V] = I(null);
  Q(() => {
    let E = !1;
    ...
    /* @__PURE__ */ e("div", { class: "n-ob__body", children: [
      g === 0 && /* @__PURE__ */ e(
        Cr,
        {
          ...
          allowedUsersCount: $ ? $.filter((E) => !S.has(E.id)).length : null
        }
      ),
      g === 1 && /* @__PURE__ */ e(Ar, { entitiesCount: i.length, areasCount: r.length }),
      g === 2 && /* @__PURE__ */ e(
        Er,
        {
          entities: i,
...
function Er(n) {
  const { entities: t, exposed: i, favs: r, onToggleExpose: o, onToggleFav: a } = n, s = N(() => {
    ...
    for (const f of t)
      at.includes(f.domain) && (m.has(f.domain) || m.set(f.domain, []), m.get(f.domain).push(f));
    return Array.from(m.entries()).sort((f, _) => _[1].length - f[1].length);
  }, [t]), [l, p] = I(s[0]?.[0] ?? "light"), [c, u] = I(""), d = s.find(([m]) => m === l) ?? s[0], h = i.size, g = t.filter((m) => at.includes(m.domain)).length, v = c.trim().toLowerCase(), b = d ? v ? d[1].filter(
  ...
  return /* @__PURE__ */ e("div", { class: "n-ob-step n-ob-step--entities", children: [
    /* @__PURE__ */ e("aside", { class: "n-ob-ent__rail", children: [
      ...
      /* @__PURE__ */ e("div", { class: "n-ob-ent__list", children: s.map(([m, f]) => {
        const _ = _e[m], x = _.Icon, z = f.filter((T) => i.has(T.entity_id)).length;
        return /* @__PURE__ */ e(
          "button",
          {
            type: "button",
          ...
          return /* @__PURE__ */ e(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ e("span", { class: `n-ob-ent-card__check ${f ? "is-on" : ""}`, children: f && /* @__PURE__ */ e(ra, { size: 12, stroke: 2.4 }) })
              ]
            }
          );
        })
...
function Dr(n) {
  ...
  return /* @__PURE__ */ e("div", { class: "n-ob-step n-ob-step--theme", children: [
    /* @__PURE__ */ e("div", { class: "n-ob-step__col", children: [
      ...
      /* @__PURE__ */ e("div", { class: "n-ob-theme__grid", children: kt.map((s) => {
        const l = ln[s];
        return /* @__PURE__ */ e(
          "button",
          {
...
function Pr({ hass: n, host: t }) {
  const [i, r] = I(null), [o, a] = I(null), [s, l] = I(null), [p, c] = I(null), u = N(() => Mt(), []), [d, h] = I(() => Ii()), [g, v] = I(() => Ci()), [b, m] = I(() => Ai()), [f, _] = I(() => Ei()), [x, z] = I(
    () => Ti()
  ), [M, T] = I(() => !Rn()), [S, j] = I({ kind: "dashboard" }), $ = (A) => {
    h(A), on(A);
  }, L = (A) => {
    _(A), Di(A);
  }, G = (A, E) => {
...
${Lr}`, this._mountPoint = document.createElement("div"), this._mountPoint.className = "nido-root-mount", t.append(i, this._mountPoint);
  ...
  _render() {
    An(ut(Pr, { hass: this._hass, host: this }), this._mountPoint);
  }
}
