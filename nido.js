var Me, E, $n, J, nn, Dn, Nn, Se, me, ae, On, Ve, Pe, $e, xe = {}, ye = [], vt = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, Ie = Array.isArray;
function W(n, t) {
...
function Ln(n, t, r) {
  ...
  if (arguments.length > 2 && (s.children = arguments.length > 3 ? Me.call(arguments, 2) : r), typeof n == "function" && n.defaultProps != null) for (a in n.defaultProps) s[a] === void 0 && (s[a] = n.defaultProps[a]);
...
function ee(n, t) {
  if (t == null) return n.__ ? ee(n.__, n.__i + 1) : null;
...
function xt(n) {
  if (n.__P && n.__d) {
    ...
    a.__v = t.__v + 1, E.vnode && E.vnode(a), Fe(n.__P, a, t, n.__n, n.__P.namespaceURI, 32 & t.__u ? [r] : null, i, r ?? ee(t), !!(32 & t.__u), o), a.__v = t.__v, a.__.__k[a.__i] = a, Fn(i, a, o), t.__e = t.__ = null, a.__e != r && jn(a);
  }
}
function jn(n) {
...
function tn(n) {
  (!n.__d && (n.__d = !0) && J.push(n) && !we.__r++ || nn != E.debounceRendering) && ((nn = E.debounceRendering) || Dn)(we);
}
function we() {
  try {
    for (var n, t = 1; J.length; ) J.length > t && J.sort(Nn), n = J.shift(), t = J.length, xt(n);
  } finally {
    J.length = we.__r = 0;
  }
}
function Vn(n, t, r, i, o, a, s, l, p, d, f) {
  var c, m, _, v, g, u, h, b = i && i.__k || ye, y = t.length;
  for (p = yt(r, t, b, p, y), c = 0; c < y; c++) (_ = r.__k[c]) != null && (m = _.__i != -1 && b[_.__i] || xe, _.__i = c, u = Fe(n, _, m, o, a, s, l, p, d, f), v = _.__e, _.ref && m.ref != _.ref && (m.ref && He(m.ref, null, _), f.push(_.ref, _.__c || v, _)), g == null && v != null && (g = v), (h = !!(4 & _.__u)) || m.__k === _.__k ? (p = Rn(_, p, n, h), h && m.__e && (m.__e = null)) : typeof _.type == "function" && u !== void 0 ? p = u : v && (p = v.nextSibling), _.__u &= -7);
  return r.__e = g, p;
}
function yt(n, t, r, i, o) {
  var a, s, l, p, d, f = r.length, c = f, m = 0;
  for (n.__k = new Array(o), a = 0; a < o; a++) (s = t[a]) != null && typeof s != "boolean" && typeof s != "function" ? (typeof s == "string" || typeof s == "number" || typeof s == "bigint" || s.constructor == String ? s = n.__k[a] = be(null, s, null, null, null) : Ie(s) ? s = n.__k[a] = be(H, { children: s }, null, null, null) : s.constructor === void 0 && s.__b > 0 ? s = n.__k[a] = be(s.type, s.props, s.key, s.ref ? s.ref : null, s.__v) : n.__k[a] = s, p = a + m, s.__ = n, s.__b = n.__b + 1, l = null, (d = s.__i = wt(s, r, p, c)) != -1 && (c--, (l = r[d]) && (l.__u |= 2)), l == null || l.__v == null ? (d == -1 && (o > f ? m-- : o < f && m++), typeof s.type != "function" && (s.__u |= 4)) : d != p && (d == p - 1 ? m-- : d == p + 1 ? m++ : (d > p ? m-- : m++, s.__u |= 4))) : n.__k[a] = null;
  if (c) for (a = 0; a < f; a++) (l = r[a]) != null && (2 & l.__u) == 0 && (l.__e == i && (i = ee(l)), Un(l, l));
  return i;
}
function Rn(n, t, r, i) {
  var o, a;
  ...
  n.__e != t && (i && (t && n.type && !t.parentNode && (t = ee(n)), r.insertBefore(n.__e, t || null)), t = n.__e);
  do
    t = t && t.nextSibling;
...
function an(n) {
  return function(t) {
    if (this.l) {
      ...
      if (t[me] == null) t[me] = Ve++;
      else if (t[me] < r[ae]) return;
      return r(E.event ? E.event(t) : t);
    }
  };
}
function Fe(n, t, r, i, o, a, s, l, p, d) {
  var f, c, m, _, v, g, u, h, b, y, z, P, O, T, R, D = t.type;
  if (t.constructor !== void 0) return null;
  128 & r.__u && (p = !!(32 & r.__u), a = [l = t.__e = r.__e]), (f = E.__b) && f(t);
  e: if (typeof D == "function") try {
    if (h = t.props, b = D.prototype && D.prototype.render, y = (f = D.contextType) && i[f.__c], z = f ? y ? y.props.value : f.__ : i, r.__c ? u = (c = t.__c = r.__c).__ = c.__E : (b ? t.__c = c = new D(h, z) : (t.__c = c = new ge(h, z), c.constructor = D, c.render = Mt), y && y.sub(c), c.state || (c.state = {}), c.__n = i, m = c.__d = !0, c.__h = [], c._sb = []), b && c.__s == null && (c.__s = c.state), b && D.getDerivedStateFromProps != null && (c.__s == c.state && (c.__s = W({}, c.__s)), W(c.__s, D.getDerivedStateFromProps(h, c.__s))), _ = c.props, v = c.state, c.__v = t, m) b && D.getDerivedStateFromProps == null && c.componentWillMount != null && c.componentWillMount(), b && c.componentDidMount != null && c.__h.push(c.componentDidMount);
    else {
      if (b && D.getDerivedStateFromProps == null && h !== _ && c.componentWillReceiveProps != null && c.componentWillReceiveProps(h, z), t.__v == r.__v || !c.__e && c.shouldComponentUpdate != null && c.shouldComponentUpdate(h, c.__s, z) === !1) {
        t.__v != r.__v && (c.props = h, c.state = c.__s, c.__d = !1), t.__e = r.__e, t.__k = r.__k, t.__k.some(function(V) {
          V && (V.__ = t);
        }), ye.push.apply(c.__h, c._sb), c._sb = [], c.__h.length && s.push(c);
        break e;
      }
    ...
    if (c.context = z, c.props = h, c.__P = n, c.__e = !1, P = E.__r, O = 0, b) c.state = c.__s, c.__d = !1, P && P(t), f = c.render(c.props, c.state, c.context), ye.push.apply(c.__h, c._sb), c._sb = [];
    else do
      c.__d = !1, P && P(t), f = c.render(c.props, c.state, c.context), c.state = c.__s;
    while (c.__d && ++O < 25);
    c.state = c.__s, c.getChildContext != null && (i = W(W({}, i), c.getChildContext())), b && !m && c.getSnapshotBeforeUpdate != null && (g = c.getSnapshotBeforeUpdate(_, v)), T = f != null && f.type === H && f.key == null ? Hn(f.props.children) : f, l = Vn(n, Ie(T) ? T : [T], t, r, i, o, a, s, l, p, d), c.base = t.__e, t.__u &= -161, c.__h.length && s.push(c), u && (c.__E = c.__ = null);
  } catch (V) {
    ...
    else t.__e = r.__e, t.__k = r.__k, V.then || De(t);
    E.__e(V, t, r);
  }
  else a == null && t.__v == r.__v ? (t.__k = r.__k, t.__e = r.__e) : l = t.__e = kt(r.__e, t, r, i, o, a, s, p, d);
  return (f = E.diffed) && f(t), 128 & t.__u ? void 0 : l;
}
function De(n) {
...
function Hn(n) {
  return typeof n != "object" || n == null || n.__b > 0 ? n : Ie(n) ? n.map(Hn) : W({}, n);
}
function kt(n, t, r, i, o, a, s, l, p) {
  var d, f, c, m, _, v, g, u = r.props || xe, h = t.props, b = t.type;
  ...
  if (n == null) {
    ...
    n = document.createElementNS(o, b, h.is && h), l && (E.__m && E.__m(t, a), l = !1), a = null;
  }
  if (b == null) u === h || l && n.data == h || (n.data = h);
  else {
    if (a = a && Me.call(n.childNodes), !l && a != null) for (u = {}, d = 0; d < n.attributes.length; d++) u[(_ = n.attributes[d]).name] = _.value;
    for (d in u) _ = u[d], d == "dangerouslySetInnerHTML" ? c = _ : d == "children" || d in h || d == "value" && "defaultValue" in h || d == "checked" && "defaultChecked" in h || pe(n, d, null, _, o);
    for (d in h) _ = h[d], d == "children" ? m = _ : d == "dangerouslySetInnerHTML" ? f = _ : d == "value" ? v = _ : d == "checked" ? g = _ : l && typeof _ != "function" || u[d] === _ || pe(n, d, _, u[d], o);
    if (f) l || c && (f.__html == c.__html || f.__html == n.innerHTML) || (n.innerHTML = f.__html), t.__k = [];
    else if (c && (n.innerHTML = ""), Vn(t.type == "template" ? n.content : n, Ie(m) ? m : [m], t, r, i, b == "foreignObject" ? "http://www.w3.org/1999/xhtml" : o, a, s, a ? a[0] : r.__k && ee(r, 0), l, p), a != null) for (d = a.length; d--; ) Re(a[d]);
    l || (d = "value", b == "progress" && v == null ? n.removeAttribute("value") : v != null && (v !== n[d] || b == "progress" && !v || b == "option" && v != u[d]) && pe(n, d, v, u[d], o), d = "checked", g != null && g != n[d] && pe(n, d, g, u[d], o));
  }
  return n;
}
function He(n, t, r) {
...
function on(n, t, r) {
  var i, o, a, s;
  t == document && (t = document.documentElement), E.__ && E.__(n, t), o = (i = !1) ? null : t.__k, a = [], s = [], Fe(t, n = t.__k = Ln(H, null, [n]), o || xe, xe, t.namespaceURI, o ? null : t.firstChild ? Me.call(t.childNodes) : null, a, o ? o.__e : t.firstChild, i, s), Fn(a, n, s);
}
Me = ye.slice, E = { __e: function(n, t, r, i) {
  ...
  throw n;
} }, $n = 0, ge.prototype.setState = function(n, t) {
  var r;
  r = this.__s != null && this.__s != this.state ? this.__s : this.__s = W({}, this.state), typeof n == "function" && (n = n(W({}, r), this.props)), n && W(r, n), n != null && this.__v && (t && this._sb.push(t), tn(this));
}, ge.prototype.forceUpdate = function(n) {
  this.__v && (this.__e = !0, n && this.__h.push(n), tn(this));
}, ge.prototype.render = H, J = [], Dn = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, Nn = function(n, t) {
  return n.__v.__b - t.__v.__b;
}, we.__r = 0, Se = Math.random().toString(8), me = "__d" + Se, ae = "__a" + Se, On = /(PointerCapture)$|Capture$/i, Ve = 0, Pe = an(!1), $e = an(!0);
var It = 0;
...
var se, $, Ce, sn, le = 0, Bn = [], N = E, ln = N.__b, cn = N.__r, dn = N.diffed, pn = N.__c, un = N.unmount, hn = N.__;
function Ue(n, t) {
  N.__h && N.__h($, n, le || t), le = 0;
...
function K(n, t) {
  var r = Ue(se++, 3);
  !N.__s && Wn(r.__H, t) && (r.__ = n, r.u = t, $.__H.__h.push(r));
}
function Q(n) {
...
function St() {
  for (var n; n = Bn.shift(); ) {
    var t = n.__H;
    if (n.__P && t) try {
      t.__h.some(ve), t.__h.some(Ne), t.__h = [];
    } catch (r) {
      t.__h = [], N.__e(r, n.__v);
    }
  }
...
N.__b = function(n) {
  ...
  })) : (t.__h.some(ve), t.__h.some(Ne), t.__h = [], se = 0)), Ce = $;
}, N.diffed = function(n) {
  dn && dn(n);
  var t = n.__c;
  t && t.__H && (t.__H.__h.length && (Bn.push(t) !== 1 && sn === N.requestAnimationFrame || ((sn = N.requestAnimationFrame) || Ct)(St)), t.__H.__.some(function(r) {
    r.u && (r.__H = r.u), r.u = void 0;
  })), Ce = $ = null;
}, N.__c = function(n, t) {
  t.some(function(r) {
    try {
      r.__h.some(ve), r.__h = r.__h.filter(function(i) {
        return !i.__ || Ne(i);
      });
    } catch (i) {
      t.some(function(o) {
...
const j = {
  ...
  theme: "nido.theme",
  mode: "nido.mode"
}, Jn = ["terracotta", "miel", "sauge", "cosy"], Nt = ["light", "dark"];
function B() {
  try {
...
const Lt = () => Be(j.exposed), mn = (n) => We(j.exposed, n), jt = () => Be(j.excludedUsers), bn = (n) => We(j.excludedUsers, n), Vt = () => Be(j.roomsOrder), Rt = (n) => We(j.roomsOrder, n);
function Ft() {
  const n = B();
  if (!n) return {};
...
function gn() {
  return B()?.getItem(j.onboarded) === "1";
}
function vn(n) {
  const t = B();
...
function Xn() {
  const n = B(), t = n?.getItem(j.theme), r = n?.getItem(j.mode);
  return {
    theme: Jn.includes(t) ? t : "terracotta",
    mode: Nt.includes(r) ? r : "light"
  };
}
function xn(n, t) {
  const r = B();
...
function Le(n, t, r) {
  const [i, o] = w({ draggingId: null, overId: null }), a = Q(null), s = Q(null), l = Q(n);
  l.current = n;
  const p = Q(r);
  p.current = r;
  const d = Q(t);
  ...
  K(() => {
    const m = (v) => {
      ...
      window.addEventListener("click", g, { capture: !0, once: !0 }), o((u) => {
        ...
        if (h && b && h !== b) {
          const y = l.current, z = d.current, P = y.findIndex((T) => z(T) === h), O = y.findIndex((T) => z(T) === b);
          if (P >= 0 && O >= 0) {
            const T = [...y], [R] = T.splice(P, 1);
            T.splice(O, 0, R), p.current(T);
          }
        }
...
] }), Wt = (n) => /* @__PURE__ */ e(x, { ...n, children: /* @__PURE__ */ e("path", { d: "m9 6 6 6-6 6" }) }), Ye = (n) => /* @__PURE__ */ e(x, { ...n, children: [
...
] }), Kt = (n) => /* @__PURE__ */ e(x, { ...n, children: /* @__PURE__ */ e("path", { d: "M5 12h14" }) }), Qt = (n) => /* @__PURE__ */ e(x, { ...n, children: /* @__PURE__ */ e("path", { d: "M12 5v14M5 12h14" }) }), ne = (n) => /* @__PURE__ */ e(x, { ...n, children: /* @__PURE__ */ e("path", { d: "M7 5v14l12-7Z" }) }), Kn = (n) => /* @__PURE__ */ e(x, { ...n, children: [
...
] }), ue = (n) => /* @__PURE__ */ e(x, { ...n, children: /* @__PURE__ */ e("path", { d: "m13 2-9 12h7l-2 8 9-12h-7l2-8Z" }) }), Ge = (n) => /* @__PURE__ */ e(x, { ...n, children: [
...
function rt({
  ...
  const a = t.state.state === "on", s = t.state.state === "unavailable", [l, p] = w(!1), [d, f] = w(null), c = d ?? Ar(t.state), m = async () => {
    if (!s) {
      p(!0);
      try {
...
function at({ hass: n, entity: t, roomLabel: r }) {
  const i = t.state.state === "unavailable", [o, a] = w(null), s = o ?? Er(t.state), l = s > 0, p = async (d) => {
    a(d);
    try {
...
function it({
  ...
  const o = t.state.state === "on", a = t.state.state === "unavailable", [s, l] = w(!1), p = t.state.attributes.current_power_w, d = async () => {
    if (!a) {
      l(!0);
      try {
...
function st({
  ...
  const o = t.state.state === "unavailable", a = t.state.state, s = a !== "off" && !o, l = t.state.attributes.current_temperature, p = t.state.attributes.temperature, d = t.state.attributes.min_temp ?? 7, f = t.state.attributes.max_temp ?? 35, c = t.state.attributes.target_temp_step ?? 0.5, [m, _] = w(null), v = m ?? p ?? l ?? 20, g = async (b) => {
    const y = Math.min(f, Math.max(d, b));
    _(y);
    try {
  ...
  }, u = Nr[a] ?? X, h = ["n-card", s ? `breathe-${i}` : ""].filter(Boolean).join(" ");
...
function lt({ hass: n, entity: t, roomLabel: r }) {
  const i = t.state.state, o = i === "unavailable", a = i === "locked", s = i === "jammed", l = i === "locking" || i === "unlocking", [p, d] = w(!1), f = async () => {
    if (!(o || l || p)) {
      d(!0);
      try {
...
function ct({
  ...
  const o = t.state.state, a = o === "unavailable", s = o === "cleaning" || o === "returning", l = o === "error", p = t.state.attributes.battery_level, [d, f] = w(!1), c = async (_) => {
    if (!(a || d)) {
      f(!0);
      try {
...
function pt({
  ...
  const o = t.state.state, a = o === "unavailable", s = o === "playing", l = o === "off" || o === "standby", p = t.state.attributes.media_title, d = t.state.attributes.media_artist, f = t.state.attributes.app_name, c = t.state.attributes.volume_level, [m, _] = w(null), v = m ?? c ?? 0, g = async (b, y = {}) => {
      ...
      /* @__PURE__ */ e("div", { class: "n-media__controls", children: [
        ...
        /* @__PURE__ */ e(
          "button",
          {
            ...
            children: s ? /* @__PURE__ */ e(rr, { size: 18 }) : /* @__PURE__ */ e(ne, { size: 18 })
          }
        ),
        /* @__PURE__ */ e(
          "button",
...
function ut({ hass: n, entity: t, roomLabel: r }) {
  const i = t.state.state, o = i === "unavailable", a = i === "triggered", s = i.startsWith("armed_"), l = i === "pending" || i === "arming" || i === "disarming", [p, d] = w(!1), f = async (c) => {
    if (!(o || p)) {
      d(!0);
      try {
...
function ht({ hass: n, entity: t, roomLabel: r }) {
  const i = t.state.state, o = i === "unavailable", a = i === "recording" || i === "streaming", [s, l] = w(0), [p, d] = w(!1), f = Ur(t, n), c = f ? `${f}${f.includes("?") ? "&" : "?"}t=${s}` : null;
  return K(() => {
    d(!1);
    ...
    /* @__PURE__ */ e("div", { class: "n-card__head n-card__head--inline", children: [
      /* @__PURE__ */ e("div", { class: "n-icon-bubble", children: /* @__PURE__ */ e(ke, { size: 18 }) }),
      /* @__PURE__ */ e(
        "button",
        {
          type: "button",
...
function _t({ hass: n, entity: t, roomLabel: r, breatheVariant: i = 2 }) {
  const o = t.state.state === "on", a = t.state.state === "unavailable", s = t.state.attributes.percentage, l = typeof s == "number", [p, d] = w(!1), [f, c] = w(null), m = f ?? (l ? s : o ? 100 : 0), _ = async () => {
    if (!a) {
      d(!0);
      try {
...
function ft({ hass: n, entity: t, roomLabel: r }) {
  const i = t.domain === "scene", o = t.state.state === "unavailable", [a, s] = w(!1), [l, p] = w(!1), d = async () => {
    if (!(o || a)) {
      s(!0);
      try {
  ...
  return /* @__PURE__ */ e(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ e("div", { class: "n-card__head", children: [
          /* @__PURE__ */ e("div", { class: "n-icon-bubble", children: i ? /* @__PURE__ */ e(en, { size: 18 }) : /* @__PURE__ */ e(ne, { size: 16 }) }),
...
function Zr({ hass: n, weatherEntityId: t, onClose: r }) {
  const [i, o] = w([]), [a, s] = w([]), l = n.states[t], { nextRain: p, weatherAlert: d, uvIndex: f } = Wr(n, t);
  if (K(() => {
    let h = !1;
    async function b() {
      try {
        const y = async (O) => (await n.callWS({
          type: "call_service",
          domain: "weather",
          ...
          target: { entity_id: t },
          return_response: !0
        }))?.[t]?.forecast || [], [z, P] = await Promise.all([
          y("daily"),
          y("hourly")
        ]);
        if (h) return;
      ...
      /* @__PURE__ */ e("div", { class: "nido-weather-panel__scroll", children: [
        ...
        /* @__PURE__ */ e("div", { class: "nido-wp-grid", children: [
          p && /* @__PURE__ */ e("div", { class: "nido-wp-card", children: [
            ...
            /* @__PURE__ */ e("div", { class: "nido-wp-card-val", children: p.state === "unknown" ? "Donnée indisponible" : new Date(p.state).getTime() > Date.now() ? `Prévue à ${new Date(p.state).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })}` : "Pas de pluie prévue" })
          ] }),
        ...
        a.length > 0 && /* @__PURE__ */ e("div", { class: "nido-wp-section", children: [
          ...
          /* @__PURE__ */ e("div", { class: "nido-wp-hourly", children: a.slice(0, 24).map((h, b) => {
            const y = oe(h.condition), z = new Date(h.datetime);
        ...
        i.length > 0 && /* @__PURE__ */ e("div", { class: "nido-wp-section", children: [
          ...
          /* @__PURE__ */ e("div", { class: "nido-wp-daily", children: i.slice(0, 5).map((h, b) => {
            const y = oe(h.condition), z = new Date(h.datetime), P = new Intl.DateTimeFormat("fr-FR", { weekday: "long" }).format(z);
...
function Kr({
  ...
  const f = n.user?.name ?? "vous", c = /* @__PURE__ */ new Date(), m = c.getHours(), { greeting: _, sub: v } = Jr(m), g = `${String(m).padStart(2, "0")}:${String(c.getMinutes()).padStart(2, "0")}`, u = c.toLocaleDateString("fr-FR", { weekday: "long", day: "numeric", month: "long" }).replace(/^\w/, (M) => M.toUpperCase()), h = L(() => new Set(o), [o]), b = L(
    () => r.filter((M) => h.has(M.entity_id) && qr.has(M.domain)),
    [r, h]
  ), y = L(
    () => b.find((M) => M.domain === "weather"),
    [b]
  ), z = L(() => y ? Object.keys(n.states).some(
    (A) => A.startsWith("sensor.") && (A.endsWith("_next_rain") || A.endsWith("_weather_alert") || A.endsWith("_uv"))
  ) : !1, [n.states, y]), [P, O] = w(!1), T = L(() => Dt(b), [b]), R = L(() => {
    const M = new Map(b.map((A) => [A.entity_id, A]));
    return i.map((A) => M.get(A)).filter((A) => !!A);
  }, [b, i]), D = L(() => {
    const M = t.filter((A) => (T.get(A.area_id) ?? []).length > 0);
    return Gn(M, a, (A) => A.area_id);
  }, [t, T, a]), V = Le(
    R,
    (M) => M.entity_id,
    (M) => p(M.map((A) => A.entity_id))
  ), G = Le(
    D,
    (M) => M.area_id,
    (M) => d(M.map((A) => A.area_id))
  );
  let Z = 0;
  const Y = R.length > 0 ? /* @__PURE__ */ e("section", { class: "nido-room nido-room--favorites", children: [
    /* @__PURE__ */ e("div", { class: "nido-section-title", children: /* @__PURE__ */ e("h2", { class: "is-accent", children: "Favoris" }) }),
    /* @__PURE__ */ e(
      "div",
      {
        class: `nido-room__grid ${V.isDragging ? "is-dragging" : ""}`,
        ref: (M) => {
          V.containerRef.current = M;
        },
        children: R.map((M) => {
          Z += 1;
          const A = (Z - 1) % 4 + 1;
          return /* @__PURE__ */ e(
            "div",
            {
              ...
              ...V.itemPropsFor(M.entity_id),
              children: Xr(M, {
                hass: n,
                areaName: t.find((U) => U.area_id === M.area_id)?.name ?? "",
                hero: Z === 1 && M.domain === "light",
                variant: A
              })
            },
            M.entity_id
  ...
  ] }, "__favorites") : null, te = b.length > 0;
  return /* @__PURE__ */ e("div", { class: "nido-shell", children: [
    /* @__PURE__ */ e("div", { class: "nido-dashboard", children: [
        ...
        /* @__PURE__ */ e("div", { class: "nido-topbar__actions", children: [
          y && (z ? /* @__PURE__ */ e(
            "button",
            {
              ...
              children: /* @__PURE__ */ e(Sn, { entity: y })
            }
          ) : /* @__PURE__ */ e(Sn, { entity: y })),
          /* @__PURE__ */ e(
            "button",
            {
              type: "button",
      ...
      te ? /* @__PURE__ */ e(H, { children: [
        Y,
        D.length > 0 && /* @__PURE__ */ e("section", { class: "nido-rooms-section", children: [
          ...
          /* @__PURE__ */ e(
            "div",
            {
              ...
              ref: (M) => {
                G.containerRef.current = M;
              },
              children: D.map((M, A) => /* @__PURE__ */ e(
                Gr,
                {
                  area: M,
                  entities: T.get(M.area_id) ?? [],
                  accent: A === 0,
                  onOpen: () => l(M.area_id),
                  dragProps: G.itemPropsFor(M.area_id)
                },
                M.area_id
              ))
            }
...
function ea({
  ...
  const s = gt(t.name), l = qn(r), p = L(
    ...
    (u) => u.entity_id,
    (u) => {
      const h = new Set(m.map((z) => z.entity_id)), b = [...u], y = p.map(
        (z) => h.has(z.entity_id) ? b.shift() : z
      );
      a(y.map((z) => z.entity_id));
    }
  ), v = p.filter(
...
const he = 5, re = {
  ...
  climate: { label: "Thermostats", Icon: X },
  ...
  camera: { label: "Caméras", Icon: ke },
  fan: { label: "Ventilateurs", Icon: Qe },
  scene: { label: "Scènes", Icon: en },
  script: { label: "Scripts", Icon: ne },
...
function na(n) {
  const {
    ...
    onClose: c,
    onDone: m
  } = n, [_, v] = w(0), [g, u] = w(o), [h, b] = w(a), [y, z] = w(new Set(s)), [P, O] = w(new Set(l)), [T, R] = w(
    new Set(p)
  ), [D, V] = w(null), [G, Z] = w(null);
  K(() => {
    let k = !1;
    return t.callWS({ type: "config/auth/list" }).then((I) => {
      ...
      k || (Z(I instanceof Error ? I.message : String(I)), t.user && V([t.user]));
    }), () => {
      k = !0;
    };
  }, [t]);
  const Y = () => v((k) => Math.min(he - 1, k + 1)), te = () => v((k) => Math.max(0, k - 1)), M = (k, I) => {
    u(k), b(I), f(k, I);
  }, A = (k) => {
    z((I) => {
      const C = new Set(I);
      return C.has(k) ? (C.delete(k), O((F) => {
        if (!F.has(k)) return F;
        const de = new Set(F);
        return de.delete(k), de;
      })) : C.add(k), C;
    });
  }, U = (k) => {
    O((I) => {
      const C = new Set(I);
      return C.has(k) ? C.delete(k) : (C.add(k), z((F) => F.has(k) ? F : new Set(F).add(k))), C;
    });
  }, ze = (k) => {
    R((I) => {
      const C = new Set(I);
    ...
    const k = Array.from(y), I = Array.from(P).filter((F) => y.has(F)), C = Array.from(T);
    xn(g, h), mn(k), Oe(I), bn(C), vn(), m({
      exposed: k,
      favorites: I,
      theme: g,
      mode: h,
    ...
    xn(g, h), mn(Array.from(y)), Oe(Array.from(P).filter((k) => y.has(k))), bn(Array.from(T)), vn(), c();
  };
  return /* @__PURE__ */ e("div", { class: "n-ob", role: "dialog", "aria-modal": "true", "aria-label": "Configuration de Nido", children: /* @__PURE__ */ e("div", { class: "n-ob__shell", children: [
    /* @__PURE__ */ e("header", { class: "n-ob__header", children: [
      ...
      /* @__PURE__ */ e("div", { class: "n-ob__stepper", children: [
        Array.from({ length: he }, (k, I) => /* @__PURE__ */ e(
          "span",
          {
      ...
      /* @__PURE__ */ e("button", { type: "button", class: "n-ob__skip", onClick: q, children: "Passer →" })
    ] }),
    /* @__PURE__ */ e("div", { class: "n-ob__body", children: [
      _ === 0 && /* @__PURE__ */ e(
        ta,
        {
          ...
          allowedUsersCount: D ? D.filter((k) => !T.has(k.id)).length : null
        }
      ),
    ...
    /* @__PURE__ */ e("footer", { class: "n-ob__footer", children: [
      ...
      _ < he - 1 ? /* @__PURE__ */ e("button", { type: "button", class: "n-ob__primary", onClick: Y, children: [
        "Continuer ",
    ...
    /* @__PURE__ */ e("div", { class: "n-ob-step__col", children: [
      ...
      t ? /* @__PURE__ */ e("div", { class: "n-ob-recap", children: [
        ...
        /* @__PURE__ */ e("div", { class: "n-ob-recap__grid", children: [
          /* @__PURE__ */ e(fe, { label: "Exposées", value: r }),
          /* @__PURE__ */ e(fe, { label: "Favoris", value: i, accent: !0 }),
          /* @__PURE__ */ e(fe, { label: "Ambiance", value: o, hint: a }),
          /* @__PURE__ */ e(
            fe,
            {
              label: "Utilisateurs",
...
function aa(n) {
  ...
  }, [t]), [l, p] = w(s[0]?.[0] ?? "light"), [d, f] = w(""), c = s.find(([u]) => u === l) ?? s[0], m = r.size, _ = t.filter((u) => An.includes(u.domain)).length, v = d.trim().toLowerCase(), g = c ? v ? c[1].filter(
  ...
  return /* @__PURE__ */ e("div", { class: "n-ob-step n-ob-step--entities", children: [
    /* @__PURE__ */ e("aside", { class: "n-ob-ent__rail", children: [
      ...
      /* @__PURE__ */ e("div", { class: "n-ob-ent__list", children: s.map(([u, h]) => {
        const b = re[u], y = b.Icon, z = h.filter((O) => r.has(O.entity_id)).length;
        return /* @__PURE__ */ e(
          "button",
          {
            type: "button",
    ...
    /* @__PURE__ */ e("section", { class: "n-ob-ent__main", children: c && /* @__PURE__ */ e(H, { children: [
      ...
      /* @__PURE__ */ e("div", { class: "n-ob-ent__grid", children: [
        ...
        g.map((u) => {
          const h = r.has(u.entity_id), b = i.has(u.entity_id), y = re[u.domain].Icon;
          return /* @__PURE__ */ e(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ e("span", { class: `n-ob-ent-card__icon ${h ? "is-on" : ""}`, children: /* @__PURE__ */ e(y, { size: 16 }) }),
...
function la({ hass: n, host: t }) {
  const [r, i] = w(null), [o, a] = w(null), [s, l] = w(null), [p, d] = w(null), f = L(() => Xn(), []), [c, m] = w(() => Ot()), [_, v] = w(() => Lt()), [g, u] = w(() => jt()), [h, b] = w(() => Vt()), [y, z] = w(
    () => Ft()
  ), [P, O] = w(() => !gn()), [T, R] = w(
    { kind: "dashboard" }
  ), D = (S) => {
  ...
  Z.current = n, K(() => {
    ...
    const q = [], k = async () => {
      ...
      if (I)
        try {
          const [C, F, de] = await Promise.all([
            At(I),
            Et(I),
            Tt(I)
          ]);
  ...
  const Y = L(() => !n || !o || !s ? [] : $t(n, o, s), [n?.states, o, s]), te = (S, q) => {
    t?.applyTheme?.(S, q);
  };
  if (!n)
  ...
  const A = L(() => new Set(_), [_]), U = T.kind === "room" ? r.find((S) => S.area_id === T.areaId) ?? null : null, ze = L(
    () => U ? Y.filter(
      (S) => S.area_id === U.area_id && A.has(S.entity_id)
    ) : [],
    [Y, U, A]
  );
  return /* @__PURE__ */ e(H, { children: [
    T.kind === "dashboard" || !U ? /* @__PURE__ */ e(
      Kr,
      {
        hass: n,
        areas: r,
      ...
      ea,
      {
        ...
        area: U,
        entities: ze,
        entitiesOrder: y[U.area_id] ?? [],
        onBack: () => R({ kind: "dashboard" }),
        onReorderEntities: (S) => G(U.area_id, S)
      }
    ),
    P && /* @__PURE__ */ e(
      na,
